                            ...
                            <div className="bg-white rounded-2xl shadow-lg overflow-hidden">
                                ...
                                {selectedDocument.fileName?.endsWith('.pdf') ? (
                                    <div className="relative">
                                        <iframe
                                            src={`/uploads/documents/${selectedDocument.fileName}`}
                                ...
                                <div className="p-6 border-t border-gray-100">
                                    <h2 className="text-xl font-bold mb-2">{selectedDocument.title}</h2>
                                    ...
                                    <div className="flex gap-3">
                                        ...
                                        {selectedDocument.fileName?.endsWith('.pdf') && (
                                            <a
                                                ...
                                                className="btn btn-outline-secondary inline-flex items-center gap-2 no-underline"
                                            >
