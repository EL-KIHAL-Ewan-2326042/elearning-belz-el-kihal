...
#[ApiResource(
    operations: [
        ...
        new Patch(security: "is_granted('ROLE_TEACHER') and object.getTeacher() == user"),
        new Delete(security: "is_granted('ROLE_TEACHER') and object.getTeacher() == user"),
        new Post(
...
class Course
{
    ...
    #[Groups(['course:list', 'course:read', 'course:write', 'quiz_attempt:read'])]
