...
#[ApiResource(
    operations: [
        ...
        new Patch(security: "is_granted('ROLE_TEACHER') and object.getCourse().getTeacher() == user"),
        new Delete(security: "is_granted('ROLE_TEACHER') and object.getCourse().getTeacher() == user"),
        new Get(
            uriTemplate: '/quizzes/{id}/results',
            controller: QuizResultsController::class,
            output: QuizResultsDto::class,
            name: 'quiz_results',
            security: "is_granted('ROLE_TEACHER') and object.getCourse().getTeacher() == user"
        )
    ],
